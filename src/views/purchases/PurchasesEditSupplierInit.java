...
public class PurchasesEditSupplierInit {
    
    private final PurchasesEditSupplier view;
    private final Button buttonGenerator = new Button(); 
    private final ImageCustom imageGenerator = new ImageCustom();
    private final Input inputGenerator = new Input();

    public PurchasesEditSupplierInit(PurchasesEditSupplier view) {
        this.view = view;
    }
    ...
    public void init() {
        ...
        buttonGenerator.solidButton(view.btnEditSupplier, ViewConstants.skyColor, "#FFFFFF", 12);
        buttonGenerator.addIcon(view.btnEditSupplier, "icon-save", 20);
        buttonGenerator.outlineButton(view.btnCancelEditSupplier, ViewConstants.errorColor, ViewConstants.errorColor);
        buttonGenerator.addIcon(view.btnCancelEditSupplier, "icon-left-red", 20);
